...
urlpatterns = [
    ...
    path("api/cps-sem-zona/", views.api_cps_sem_zona, name="api-cps-sem-zona"),
    path("api/zonas/conflitos/", views.api_zonas_conflitos, name="api-zonas-conflitos"),
    path("api/triagem/", views.api_triagem, name="api-triagem"),
