...
urlpatterns = [
    ...
    # Debug views
    path(
        "debug-week-efficiency/",
        views.debug_week_efficiency,
        name="debug_week_efficiency",
    ),
    # API endpoints
    ...
    path(
        "driversmanagement/",
        driversmanagement.drivers_management_view,
        name="drivers_management",
    ),
    path(
        "driversmanagement/edit/<int:access_id>/",
        driversmanagement.edit_driver_access,
        name="edit_driver_access",
    ),
    path(
