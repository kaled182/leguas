...
class SystemConfiguration(models.Model):
    ...
    google_maps_api_key = EncryptedCharField(
        "Google Maps API Key", max_length=512, blank=True, null=True
    )
    map_default_zoom = models.IntegerField("Zoom Padrão", default=12)
    map_default_lat = models.DecimalField(
        "Latitude Padrão", max_digits=10, decimal_places=7, default=41.69314
    )
    map_default_lng = models.DecimalField(
        "Longitude Padrão", max_digits=10, decimal_places=7, default=-8.83565
    )
    ...
    # Maps - Mapbox
    mapbox_access_token = EncryptedCharField(
        "Mapbox Access Token", max_length=512, blank=True, null=True
    )
    mapbox_style = models.CharField(
        "Estilo Mapbox",
        max_length=255,
        default="mapbox://styles/mapbox/streets-v12",
    )
    mapbox_custom_style = models.CharField(
        "Estilo Customizado Mapbox", max_length=255, blank=True, null=True
    )
    mapbox_enable_3d = models.BooleanField("Ativar 3D Mapbox", default=False)

    # Maps - Esri
    esri_api_key = EncryptedCharField(
        "Esri API Key", max_length=512, blank=True, null=True
    )
    ...
    enable_drawing_tools = models.BooleanField(
        "Ativar Ferramentas de Desenho", default=True
    )
    enable_fullscreen = models.BooleanField("Ativar Fullscreen", default=True)

    # Maps - OSM
    osm_tile_server = models.CharField(
        "Servidor de Tiles OSM", max_length=255, blank=True, null=True
    )
    ...
    gdrive_folder_id = EncryptedCharField(
        "Google Drive Folder ID", max_length=255, blank=True, null=True
    )
    gdrive_shared_drive_id = EncryptedCharField(
        "Google Drive Shared Drive ID", max_length=255, blank=True, null=True
    )
    gdrive_oauth_client_id = EncryptedCharField(
        "OAuth Client ID", max_length=255, blank=True, null=True
    )
    gdrive_oauth_client_secret = EncryptedCharField(
        "OAuth Client Secret", max_length=255, blank=True, null=True
    )
    gdrive_oauth_refresh_token = EncryptedCharField(
        "OAuth Refresh Token", max_length=512, blank=True, null=True
    )
    gdrive_oauth_user_email = EncryptedCharField(
        "OAuth User Email", max_length=255, blank=True, null=True
    )
    ...
    ftp_user = EncryptedCharField(
        "Utilizador FTP", max_length=255, blank=True, null=True
    )
    ftp_password = EncryptedCharField(
        "Senha FTP", max_length=255, blank=True, null=True
    )
    ftp_directory = EncryptedCharField(
        "Diretório FTP", max_length=255, blank=True, null=True
    )
    ...
    smtp_port = EncryptedCharField(
        "Porta SMTP", max_length=32, blank=True, null=True, default="587"
    )
    smtp_security = EncryptedCharField(
        "Segurança SMTP", max_length=16, blank=True, null=True, default="TLS"
    )
    smtp_user = EncryptedCharField(
        "Utilizador SMTP", max_length=255, blank=True, null=True
    )
    smtp_password = EncryptedCharField(
        "Senha SMTP", max_length=255, blank=True, null=True
    )
    smtp_auth_mode = EncryptedCharField(
        "Modo de Autenticação SMTP",
        max_length=32,
        blank=True,
        null=True,
        default="password",
    )
    smtp_oauth_client_id = EncryptedCharField(
        "OAuth Client ID SMTP", max_length=255, blank=True, null=True
    )
    smtp_oauth_client_secret = EncryptedCharField(
        "OAuth Client Secret SMTP", max_length=255, blank=True, null=True
    )
    smtp_oauth_refresh_token = EncryptedCharField(
        "OAuth Refresh Token SMTP", max_length=512, blank=True, null=True
    )
    smtp_from_name = EncryptedCharField(
        "Nome do Remetente", max_length=255, blank=True, null=True
    )
    smtp_from_email = EncryptedCharField(
        "E-mail do Remetente", max_length=255, blank=True, null=True
    )
    smtp_test_recipient = EncryptedCharField(
        "Destinatário de Teste", max_length=255, blank=True, null=True
    )
    ...
    sms_account_sid = EncryptedCharField(
        "Account SID/Username SMS", max_length=255, blank=True, null=True
    )
    sms_auth_token = EncryptedCharField(
        "Auth Token/Password SMS", max_length=512, blank=True, null=True
    )
    sms_api_key = EncryptedCharField(
        "API Key SMS", max_length=512, blank=True, null=True
    )
    sms_api_url = EncryptedCharField(
        "API URL SMS", max_length=512, blank=True, null=True
    )
    sms_from_number = EncryptedCharField(
        "Número de Envio SMS", max_length=64, blank=True, null=True
    )
    sms_test_recipient = EncryptedCharField(
        "Destinatário de Teste SMS", max_length=64, blank=True, null=True
    )
    sms_test_message = EncryptedCharField(
        "Mensagem de Teste SMS", max_length=255, blank=True, null=True
    )
    sms_priority = EncryptedCharField(
        "Prioridade SMS", max_length=16, blank=True, null=True
    )

    # SMS - AWS SNS specific
    sms_aws_region = EncryptedCharField(
        "AWS Region", max_length=64, blank=True, null=True
    )
    sms_aws_access_key_id = EncryptedCharField(
        "AWS Access Key ID", max_length=255, blank=True, null=True
    )
    sms_aws_secret_access_key = EncryptedCharField(
        "AWS Secret Access Key", max_length=255, blank=True, null=True
    )

    # SMS - Infobip specific
    sms_infobip_base_url = EncryptedCharField(
        "Infobip Base URL", max_length=255, blank=True, null=True
    )

    # WhatsApp Configuration (Evolution API)
    whatsapp_enabled = models.BooleanField("WhatsApp Ativado", default=False)
    whatsapp_evolution_api_url = EncryptedCharField(
        "Evolution API URL", max_length=512, blank=True, null=True
    )
    whatsapp_evolution_api_key = EncryptedCharField(
        "Evolution API Key", max_length=512, blank=True, null=True
    )
    whatsapp_instance_name = models.CharField(
        "Nome da Instância WhatsApp", max_length=255, blank=True, null=True
    )

    # Typebot Configuration
    typebot_enabled = models.BooleanField("Typebot Ativado", default=False)
    typebot_builder_url = EncryptedCharField(
        "Typebot Builder URL",
        max_length=512,
        blank=True,
        null=True,
    ...
    typebot_viewer_url = EncryptedCharField(
        "Typebot Viewer URL",
        max_length=512,
        blank=True,
        null=True,
    ...
    typebot_api_key = EncryptedCharField(
        "Typebot API Key", max_length=512, blank=True, null=True
    )
    typebot_admin_email = EncryptedCharField(
        "Typebot Admin Email", max_length=255, blank=True, null=True
    )
    typebot_admin_password = EncryptedCharField(
        "Typebot Admin Password", max_length=255, blank=True, null=True
    )
    typebot_encryption_secret = EncryptedCharField(
        "Typebot Encryption Secret", max_length=512, blank=True, null=True
    )
    typebot_database_url = EncryptedCharField(
        "Typebot Database URL", max_length=512, blank=True, null=True
    )
    typebot_s3_endpoint = EncryptedCharField(
        "Typebot S3 Endpoint", max_length=512, blank=True, null=True
    )
    typebot_s3_bucket = EncryptedCharField(
        "Typebot S3 Bucket", max_length=255, blank=True, null=True
    )
    typebot_s3_access_key = EncryptedCharField(
        "Typebot S3 Access Key", max_length=255, blank=True, null=True
    )
    typebot_s3_secret_key = EncryptedCharField(
        "Typebot S3 Secret Key", max_length=512, blank=True, null=True
    )
    typebot_smtp_host = EncryptedCharField(
        "Typebot SMTP Host", max_length=255, blank=True, null=True
    )
    typebot_smtp_port = models.IntegerField(
        "Typebot SMTP Port", default=587, blank=True, null=True
    )
    typebot_smtp_username = EncryptedCharField(
        "Typebot SMTP Username", max_length=255, blank=True, null=True
    )
    typebot_smtp_password = EncryptedCharField(
        "Typebot SMTP Password", max_length=512, blank=True, null=True
    )
    typebot_smtp_from = EncryptedCharField(
        "Typebot SMTP From", max_length=255, blank=True, null=True
    )
    typebot_google_client_id = EncryptedCharField(
        "Typebot Google Client ID", max_length=512, blank=True, null=True
    )
    typebot_google_client_secret = EncryptedCharField(
        "Typebot Google Client Secret", max_length=512, blank=True, null=True
    )
    ...
    db_host = EncryptedCharField(
        "Host da Base de Dados", max_length=512, blank=True, null=True
    )
    db_port = EncryptedCharField(
        "Porta da Base de Dados", max_length=64, blank=True, null=True
    )
    db_name = EncryptedCharField(
        "Nome da Base de Dados", max_length=512, blank=True, null=True
    )
    db_user = EncryptedCharField(
        "Utilizador da Base de Dados", max_length=512, blank=True, null=True
    )
    db_password = EncryptedCharField(
        "Senha da Base de Dados", max_length=512, blank=True, null=True
    )

    # Redis Configuration
    redis_url = EncryptedCharField(
        "URL do Redis", max_length=512, blank=True, null=True
    )
    ...
    cron_metrics_last_run = models.DateTimeField(
        "Última Execução (Métricas)", null=True, blank=True, editable=False
    )
    ...
    cron_forecasts_last_run = models.DateTimeField(
        "Última Execução (Forecasts)", null=True, blank=True, editable=False
    )
    ...
    cron_alerts_last_run = models.DateTimeField(
        "Última Execução (Alertas)", null=True, blank=True, editable=False
    )
...
class ConfigurationAudit(models.Model):
    ...
    user = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, verbose_name="Utilizador"
    )
...
class CronJobExecution(models.Model):
    ...
    job_type = models.CharField(
        "Tipo de Job", max_length=20, choices=JOB_TYPES, db_index=True
    )
    ...
    duration_seconds = models.FloatField(
        "Duração (segundos)", null=True, blank=True, editable=False
    )
    status = models.CharField(
        "Status", max_length=20, choices=STATUS_CHOICES, default="running"
    )
...
class MessagingGateway(models.Model):
    ...
    gateway_type = models.CharField(
        "Tipo de Gateway", max_length=16, choices=GATEWAY_TYPES
    )
...
class CompanyProfile(models.Model):
    ...
    assets_logo = models.ImageField(
        "Logotipo (Assets)", upload_to="company/logos/", null=True, blank=True
    )
    assets_favicon = models.ImageField(
        "Favicon", upload_to="company/favicon/", null=True, blank=True
    )
    primary_color = models.CharField(
        "Cor Primária",
        max_length=7,
        default="#0ea5e9",
        help_text="Código hexadecimal (ex: #0ea5e9)",
    )
    secondary_color = models.CharField(
        "Cor Secundária",
        max_length=7,
        default="#0369a1",
        help_text="Código hexadecimal (ex: #0369a1)",
    )
    created_at = models.DateTimeField("Criado em", auto_now_add=True)
    updated_at = models.DateTimeField("Atualizado em", auto_now=True)
