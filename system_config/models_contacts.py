...
class Contact(models.Model):
    ...
    last_message_sent = models.DateTimeField(
        null=True, blank=True, verbose_name="Última mensagem enviada"
    )
    message_count = models.IntegerField(
        default=0, verbose_name="Total de mensagens enviadas"
    )
...
class ImportHistory(models.Model):
    ...
    successful_imports = models.IntegerField(
        default=0, verbose_name="Importações bem-sucedidas"
    )
