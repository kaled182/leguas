...
from .models_contacts import (  # Import contact models
    Contact,
    ContactGroup,
    ImportHistory,
)
...
class FirstTimeSetup(models.Model):
    ...
    map_default_lat = models.DecimalField(
        max_digits=10, decimal_places=7, default=-15.7801
    )
    map_default_lng = models.DecimalField(
        max_digits=10, decimal_places=7, default=-47.9292
    )
    map_type = models.CharField(
        max_length=20, default="terrain"
    )  # terrain é mais claro e sem grid
    ...
    mapbox_style = models.CharField(
        max_length=255, default="mapbox://styles/mapbox/streets-v12"
    )
...
class MonitoringServer(models.Model):
    ...
    server_type = models.CharField(
        max_length=20, choices=SERVER_TYPES, default="zabbix"
    )
...
class MessagingGateway(models.Model):
    ...
    site_name = models.CharField(
        ...
        blank=True,
        null=True,
        help_text="Nome do site onde o dispositivo está localizado (apenas para gateways de vídeo)",
    )
...
class AlertTemplate(models.Model):
    ...
    category = models.CharField(
        max_length=40, choices=CATEGORY_CHOICES, default=CATEGORY_GENERIC
    )
    ...
    content = models.TextField(
        help_text="Mensagem enviada ao contato. Use variáveis com {{chaves}}."
    )
...
class CompanyProfile(models.Model):
    ...
    assets_logo = models.FileField(
        upload_to="setup_app/company/logo/", blank=True, null=True
    )
    assets_cert_file = models.FileField(
        upload_to="setup_app/company/cert/", blank=True, null=True
    )
